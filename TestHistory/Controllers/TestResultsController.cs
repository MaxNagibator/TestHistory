...
namespace TestHistory.Controllers
{
    ...
    public class TestResultsController : ControllerBase
    {
        ...
        ///    "--$boundary--$LF"
        ///) -join $LF
        ///Invoke-RestMethod 'http://localhost:5047/api/TestResults/CreateFromZip?branch=dev-1&job=2&pipe=3'' -Method POST -ContentType "multipart/form-data; boundary=`"$boundary`"" -Body $bodyLines
        /// </remarks>
        /// <returns></returns>
